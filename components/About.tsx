...
import { motion } from "framer-motion"; // Used sparingly for Hero entrance only
...
// ============================================
// 1. ABOUT HERO SECTION (Optimized)
// ============================================
...
const AboutHero: React.FC<AboutHeroProps> = ({ data, loading }) => {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-slate-50">
      {/* 1. Dynamic Background Layer (Static for performance) */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Left Column: Story & Vision - Simple Fade In */}
          <motion.div
          ...
          >
            ...
            <div className="relative w-full max-w-lg">
              {/* Decorative Back Shape (Rotated CSS) */}
...
const MissionVision: React.FC<{ data: any }> = ({ data }) => {
  return (
    <section className="relative py-12 md:py-16 bg-gray-50 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-neobyte-teal/10 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
...
// ============================================
// 3. CORE VALUES (Optimized - No Stagger Animation)
// ============================================
  ...
  return (
    <section className="relative py-16 lg:py-20 bg-neobyte-navy overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Removed framer-motion AnimatePresence/stagger */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {values?.map((val: any, idx: any) => (
            ...
            >
              {/* Card Border Gradient (CSS opacity transition) */}
